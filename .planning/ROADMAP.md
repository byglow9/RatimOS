...
- [x] 02-02-PLAN.md — content_items+ota_releases schema, whats-new Edge Function, seed data (D-10/D-11/D-12/D-13)
- [x] 02-03-PLAN.md — sync_client.h/.c (cJSON-backed whats-new client) + offline unit suite
...
- [x] 02.1-01-PLAN.md — Tracer: write-capable game-state storage domain + Conexo end-to-end + shared progression counter (D-01/D-02/D-05/D-09/D-10/D-11)

**Wave 2** *(blocked on Wave 1)*

- [x] 02.1-02-PLAN.md — Visual identity: pixel-art icon pipeline, two-tier typography, provenance/distinctness record (D-07/D-08)

**Wave 3** *(blocked on Wave 2)*

- [x] 02.1-03-PLAN.md — Progression: additive-safe stage manifest, garden-inside-castle artwork, castelo screen + home tile (D-03/D-04/D-05/D-06/D-06a)
...
- [x] 02.1-05-PLAN.md — Paciência (Klondike): per-move-type legality engine, tap-to-move screen, persistence

**Wave 6** *(blocked on Wave 5)*

- [x] 02.1-06-PLAN.md — Termo/Dueto/Quarteto: PT-BR word curation, duplicate-safe feedback, 3-mode screen (D-01a/D-01b)
...
| 02.1. Visual Identity & Games (Simulator-Buildable Scope) *(INSERTED)* | 9/12 | In Progress|  |
